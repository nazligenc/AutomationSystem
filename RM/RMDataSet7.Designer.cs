...
namespace RM {
    ...
    public partial class RMDataSet7 : global::System.Data.DataSet {
        ...
        public partial class operationDataTable : global::System.Data.TypedTableBase<operationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public operationRow AddoperationRow(string urunadi, double urunfiyati) {
...
namespace RM.RMDataSet7TableAdapters {
    ...
    public partial class operationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[operation] WHERE (([urunID] = @Original_urunID) AND ((@IsNull_" +
                "urunadi = 1 AND [urunadi] IS NULL) OR ([urunadi] = @Original_urunadi)) AND ((@Is" +
                "Null_urunfiyati = 1 AND [urunfiyati] IS NULL) OR ([urunfiyati] = @Original_urunf" +
                "iyati)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[operation] ([urunadi], [urunfiyati]) VALUES (@urunadi, @urunfi" +
                "yati);\r\nSELECT urunID, urunadi, urunfiyati FROM operation WHERE (urunID = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[operation] SET [urunadi] = @urunadi, [urunfiyati] = @urunfiyati WHERE (([urunID] = @Original_urunID) AND ((@IsNull_urunadi = 1 AND [urunadi] IS NULL) OR ([urunadi] = @Original_urunadi)) AND ((@IsNull_urunfiyati = 1 AND [urunfiyati] IS NULL) OR ([urunfiyati] = @Original_urunfiyati)));
SELECT urunID, urunadi, urunfiyati FROM operation WHERE (urunID = @urunID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT urunID, urunadi, urunfiyati FROM dbo.operation";
        ...
        public virtual int Fill(RMDataSet7.operationDataTable dataTable) {
        ...
        public virtual RMDataSet7.operationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RMDataSet7.operationDataTable dataTable = new RMDataSet7.operationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RMDataSet7.operationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_urunID, string Original_urunadi, global::System.Nullable<double> Original_urunfiyati) {
        ...
        public virtual int Insert(string urunadi, global::System.Nullable<double> urunfiyati) {
            if ((urunadi == null)) {
        ...
        public virtual int Update(string urunadi, global::System.Nullable<double> urunfiyati, int Original_urunID, string Original_urunadi, global::System.Nullable<double> Original_urunfiyati, int urunID) {
            if ((urunadi == null)) {
            ...
            if ((Original_urunfiyati.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((double)(Original_urunfiyati.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string urunadi, global::System.Nullable<double> urunfiyati, int Original_urunID, string Original_urunadi, global::System.Nullable<double> Original_urunfiyati) {
            return this.Update(urunadi, urunfiyati, Original_urunID, Original_urunadi, Original_urunfiyati, Original_urunID);
        }
    }
